...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r mt-6 from-gray-900 via-gray-700 to-gray-900 pt-12 pb-6 px-10 font-sans tracking-wide relative">
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="flex sm:justify-between flex-wrap gap-6">
          <div className="flex space-x-5">
            <a href="#_" className="text-gray-400 hover:text-white text-sm transition-all">
          ...
          <p className="text-gray-400 text-sm">© SLASH Realty. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
